        ...
        self._mapping = [
            {
                ...
                "filters": {
                    ...
                    "pvc": {"field": "pvc", "operation": "icontains"},
                ...
                "group_by_options": ["cluster", "project", "node", "pvc"],
                ...
                "report_type": {
                    ...
                    "volume": {
                        ...
                        "aggregates": {
                            ...
                            "pvcs": ArrayAgg("pvc", distinct=True),
                            "storage_classes": ArrayAgg("storageclass", distinct=True),
                        },
                        "default_ordering": {"usage": "desc"},
                        "capacity_aggregate": {
                            "cluster": {
